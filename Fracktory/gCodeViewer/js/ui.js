...
//                var resultSet = [];
    ...
    return {
        ...
        var tab2D = document.getElementById('tab2d');
        var properties = window.getComputedStyle(tab2d,null);
        var width = parseInt (properties.width,10);
        var height = parseInt (properties.height,10);
        if(width>height){
        canvas.height = canvas.width= height-50;            
        }
        else
        {
            canvas.height = canvas.width= width-50;
        }
